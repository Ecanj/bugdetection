<template>
  <div :class="prefixCls" class="login-background-img">
    ...
    <div class="aui-logo" v-if="!getIsMobile"></div>
          ...
          <div class="aui-form">
            <div class="aui-image">
              <div class="aui-image-text">
                <h1 class="image-text-title">烟草虫害监控系统</h1>
              </div>
            </div>
...
<!--                        </div>-->
                ...
                <div class="aui-formButton" style="margin-top: 20px">
                  <div class="aui-flex">
...
<style lang="less" scoped>
  ...
  .image-text-title {
    ...
    color: #32342d; /* 深色字体，增强可读性 */
    margin: 10px 0; /* 缩小上下间距，将标题向上移动 */
    text-shadow: 3px 3px 8px rgba(0, 0, 0, 0.3); /* 更明显的阴影，增加立体感 */
    font-family: 'Microsoft YaHei', Arial, sans-serif; /* 设置优雅字体 */
    letter-spacing: 4px; /* 增加字间距 */
    position: relative; /* 保证对齐生效 */
    top: -10px; /* 向上移动标题 */
  }
